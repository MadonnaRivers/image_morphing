...
def process(forgery, mask, augment_prob=0, enable_aug_types=None,
            intensity={'rates': None, 'qfs': None, 'sds': None, 'ksizes': None, 'crop_size': None}, mode="train"):
...
class BasicDataloader(Dataset): # 读取list，resize
    def __init__(self, dataset_list, adv_list=None, input_size=1024, normalize_type=2,
